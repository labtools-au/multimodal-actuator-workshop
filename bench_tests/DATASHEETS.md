...
| 28BYJ-48 + ULN2003 | [lastminuteengineers.com](https://lastminuteengineers.com/28byj48-stepper-motor-arduino-tutorial/) | **2048 steps/rev**, and the constructor takes pins **IN1-IN3-IN2-IN4**, so `Stepper(2048, 8, 10, 9, 11)`. Sequential order makes it buzz instead of turn. |
